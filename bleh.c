...
#pragma config(Motor,  port8,           right1,        tmotorVex393HighSpeed_MC29, openLoop, driveRight)
#pragma config(Motor,  port9,           right2,        tmotorVex393HighSpeed_MC29, openLoop, driveRight)
#pragma config(Motor,  port10,          right3,        tmotorVex393HighSpeed_HBridge, openLoop, driveRight)
//*!!Code automatically generated by 'ROBOTC' configuration wizard               !!*//

// SmartMotorLibrary
#include "Libraries/SmartMotorLib.c" //You don't have this file in your repository... you need it to have SmartMotorLib.c -acetousk
...
#pragma systemFile // Surpresses warnings of unused functions
