...
#pragma config(Motor,  port2,           left2,         tmotorVex393HighSpeed_MC29, PIDControl, driveLeft, encoderPort, dgtl1)
...
#pragma config(Motor,  port5,           intakeB,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
...
#pragma config(Motor,  port9,           right2,        tmotorVex393HighSpeed_MC29, PIDControl, reversed, driveRight, encoderPort, dgtl3)
...
task autonomous()
{
	...
	if(SensorValue[jumper3]==1){
		autonR1(); // Red flag auton
	}
	if(SensorValue[jumper4]==1){
