...
#pragma config(Motor,  port2,           left2,         tmotorVex393HighSpeed_MC29, openLoop, encoderPort, dgtl1)
...
#pragma config(Motor,  port9,           right2,        tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, dgtl3)
